...
// یه سرور HTTP معمولی می‌سازیم تا هم به health-checkهای Render جواب بده
// و هم زیرساخت درخواست‌های WebSocket (upgrade) رو ازش رد کنیم.
const httpServer = http.createServer((req, res) => {
  res.writeHead(200, { 'Content-Type': 'text/plain; charset=utf-8' });
  res.end('سرور رله‌ی مالتی‌پلیر بازی تیراندازی در حال اجراست.\n');
});
...
httpServer.listen(PORT, () => {
  console.log('سرور HTTP/WebSocket روی پورت ' + PORT + ' آماده‌ی دریافت اتصاله');
});
